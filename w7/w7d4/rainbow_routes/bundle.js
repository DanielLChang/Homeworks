...
/***/ function(module, exports, __webpack_require__) {
	...
	var _red = __webpack_require__(222);
	
	var _red2 = _interopRequireDefault(_red);
	
	var _orange = __webpack_require__(223);
	
	var _orange2 = _interopRequireDefault(_orange);
	
	var _yellow = __webpack_require__(224);
	
	var _yellow2 = _interopRequireDefault(_yellow);
	
	var _green = __webpack_require__(225);
	
	var _green2 = _interopRequireDefault(_green);
	
	var _blue = __webpack_require__(226);
	
	var _blue2 = _interopRequireDefault(_blue);
	
	var _indigo = __webpack_require__(227);
	
	var _indigo2 = _interopRequireDefault(_indigo);
	
	var _violet = __webpack_require__(228);
	...
	var Rainbow = function (_React$Component) {
	  ...
	  function Rainbow() {
	    ...
	    var _this = _possibleConstructorReturn(this, (Rainbow.__proto__ || Object.getPrototypeOf(Rainbow)).call(this));
	
	    _this.addRed = _this.addRed.bind(_this);
	    _this.addGreen = _this.addGreen.bind(_this);
	    _this.addBlue = _this.addBlue.bind(_this);
	    _this.addViolet = _this.addViolet.bind(_this);
	    return _this;
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Red = function (_React$Component) {
	  ...
	  function Red() {
	    ...
	    var _this = _possibleConstructorReturn(this, (Red.__proto__ || Object.getPrototypeOf(Red)).call(this));
	
	    _this.resetRed = _this.resetRed.bind(_this);
	    _this.addOrange = _this.addOrange.bind(_this);
	    _this.addYellow = _this.addYellow.bind(_this);
	    return _this;
	  }
	  ...
	  _createClass(Red, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'h4',
	          { onClick: this.resetRed },
	          'Red only'
	        ),
	        _react2.default.createElement(
	          'h4',
	          { onClick: this.addOrange },
	          'Add orange'
	        ),
	        _react2.default.createElement(
	          'h4',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Blue = function (_React$Component) {
	  ...
	  function Blue() {
	    ...
	    var _this = _possibleConstructorReturn(this, (Blue.__proto__ || Object.getPrototypeOf(Blue)).call(this));
	
	    _this.resetBlue = _this.resetBlue.bind(_this);
	    _this.addIndigo = _this.addIndigo.bind(_this);
	    return _this;
	  }
	  ...
	  _createClass(Blue, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'h4',
	          { onClick: this.resetBlue },
	          'Blue only'
	        ),
	        _react2.default.createElement(
	          'h4',
	          { onClick: this.addIndigo },
	          'Add indigo'
	        ),
	        this.props.children
	      );
